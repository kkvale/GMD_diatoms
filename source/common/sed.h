...
!                      set to zero if time is initialized
      ...
      real dicwflx, sed_year, sedsa, carblith, dic13wflx, sil30wflx
      ...
      common /sed_r/ orgml(nzmax,ipmax), calgg(nzmax,ipmax),sil30wflx
      ...
      common /sed_r/ rain_cal_p(ipmax), co3_p(ipmax), dic13wflx
