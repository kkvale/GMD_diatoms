...
!     tai_idealage  = average idealage tracer
# endif
...
!     tai_dicwflx   = average carbon flux from weathering
      ...
      real tai_cocn, tai_cfa2o, tai_dicwflx, tai_dfe, tai_ddfe
#  if defined O_idealage
      real tai_idealage
      common /cdiag_r/ tai_idealage
#  endif
...
#  if defined O_kk_caco3tr
      real tai_caco3,tai_calatt,tcalatt
      common /cdiag_r/  tai_caco3,tai_calatt,tcalatt(0:km,jmt)
#  endif
      ...
      common /cdiag_r/ tai_dfe, tai_ddfe
#  if defined O_kk_ballast
      common /cdiag_r/ tai_d_B
#  endif
#  if defined O_cal_kk
      common /cdiag_r/ tai_c
#  endif
...
#  endif
#  if defined O_kk_si
      real tai_sil, tai_silflx, tai_socn
      common /cdiag_r/ tai_sil, tai_silflx, tai_socn
#  endif
# endif
# if defined O_isotopes
      real tai_dic13,tai_dic13flx
      real tai_dic13wflx
      real tai_sil30, tai_sil30flx
      real tai_sil30wflx
      real tai_phytc13,tai_phytn15
      real tai_zoopc13,tai_zoopn15
      real tai_detrc13,tai_detrn15
      real tai_coccc13,tai_coccn15
      real tai_diazc13,tai_diazn15
      real tai_diatc13,tai_diatn15,tai_diats30
      real tai_caco3c13, tai_din15

      common /cdiag_r/ tai_dic13,tai_dic13flx
      common /cdiag_r/ tai_dic13wflx
      common /cdiag_r/ tai_sil30, tai_sil30flx,tai_sil30wflx
      common /cdiag_r/ tai_phytc13,tai_phytn15
      common /cdiag_r/ tai_zoopc13,tai_zoopn15
      common /cdiag_r/ tai_detrc13, tai_detrn15
      common /cdiag_r/ tai_coccc13,tai_coccn15
      common /cdiag_r/ tai_diazc13,tai_diazn15
      common /cdiag_r/ tai_diatc13,tai_diatn15
      common /cdiag_r/ tai_caco3c13, tai_din15
# endif
