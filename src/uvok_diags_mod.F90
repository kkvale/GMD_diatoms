      ...
      INTEGER, SAVE :: id_O_chl=-1,id_O_chl_diaz=-1
      INTEGER, SAVE :: id_F_sil=-1,id_O_oplpro=-1,id_O_rivsil=-1
      INTEGER, SAVE :: id_O_diat=-1,id_O_cocc=-1
      INTEGER, SAVE :: id_O_detr_B=-1,id_O_omca=-1,id_O_co3=-1
      INTEGER, SAVE :: id_O_co3_sat=-1,id_O_del_sat=-1
      INTEGER, SAVE :: id_O_caco3att=-1,id_O_caco3dissl=-1
      INTEGER, SAVE :: id_O_coccnpp=-1,id_O_coccgraz=-1
      INTEGER, SAVE :: id_O_coccmort=-1,id_O_coccrecy=-1,id_O_diatnpp=-1
      INTEGER, SAVE :: id_O_diatgraz=-1,id_O_diatmort=-1,id_O_diatrecy=-1
      INTEGER, SAVE :: id_O_detrgraz_B,id_O_detrremi_B=-1
      INTEGER, SAVE :: id_O_detrexp_B=-1
      INTEGER, SAVE :: id_O_oplexp=-1,id_O_opldis=-1,id_O_oplbur=-1
