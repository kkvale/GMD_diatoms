...
#undef O_npzd_fe_limitation
#define O_zoop_graz_upper_temp_limit
#define O_idealage
#define O_kk_diat
#define O_kk_si_compensating_sources
#define O_kk_variable_sipr
#define O_kk_extra_diags
#define O_kk_si
#define O_cal_kk
#define O_kk_caco3tr
#define O_kk_ballast
...
#define O_npzd_subgridbathy
#undef O_npzd_cdom_attenuation
#define O_npzd_extra_diagnostics
